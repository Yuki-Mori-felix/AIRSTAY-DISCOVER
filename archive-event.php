        ...
        <?php if ($query->have_posts()): ?>
          ...
          <div class="pagenate-area">
            ...
            if (!empty($pagination_links)):
              ...
              // ▼ First（最初のページ）
              if ($paged > 1) {
                echo '<li><a class="first page-numbers" href="' . esc_url(get_pagenum_link(1)) . '">First</a></li>';
              }
              ...
              if ($paged < $query->max_num_pages) {
                echo '<li><a class="last page-numbers" href="' . esc_url(get_pagenum_link($query->max_num_pages)) . '">Last</a></li>';
              }
